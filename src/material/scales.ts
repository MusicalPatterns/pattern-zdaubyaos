...
import { from, Scalar, to, Translation } from '@musical-patterns/utilities'
...
const buildScales: BuildScalesFunction =
    (spec: StandardSpec): Scale[] => {
        ...
        const patternPitchTranslation: Translation =
            spec[ StandardSpecProperties.FREQUENCY_TRANSLATION ] || to.Translation(0)
        ...
        const patternDurationTranslation: Translation =
            spec[ StandardSpecProperties.DURATION_TRANSLATION ] || to.Translation(0)
