...
describe('other contours', () => {
    ...
    it('handles backbone twentyfour', () => {
        ...
        expect(backboneTwentyfourContour)
            .toEqual(to.Contour([
                [ 1, 1 ], [ 3, 3 ],
                [ 1, 1 ], [ 3, 3 ],
                [ 1, 1 ], [ 3, 3 ],
    ...
    it('handles shifty twentyfour', () => {
        ...
        expect(shiftyTwentyfourContour)
            .toEqual(to.Contour([
                [ 3, 3 ], [ 1, 1 ],
                [ 3, 3 ], [ 1, 1 ],
                [ 3, 3 ], [ 4, 4 ],
    ...
    it('handles shifty twentyfour variant', () => {
        ...
        expect(shiftyTwentyfourVariantContour)
            .toEqual(to.Contour([
                [ 4, 4 ], [ 7, 7 ], [ 4, 4 ],
                [ 1, 1 ], [ 3, 3 ], [ 1, 1 ], [ 3, 3 ], [ 1, 1 ],
            ]))
